        ...
        public byte[] ExportAcademiesToSpreadsheetUsingProvider(Data.Trust trust, Trust.TrustSummaryServiceModel? trustSummary, AcademyOfstedServiceModel[] ofstedRatings)
        {
            ...
            var dataExtractor = new Func<Data.Academy, string[]>((academy) =>
            {
                ...
                [
                    ...
                    previousRating.OfstedRatingScore != OfstedRatingScore.None ? previousRating.OfstedRatingScore.ToDisplayString() : string.Empty,
                    IsOfstedRatingBeforeOrAfterJoining(previousRating.OfstedRatingScore, academy.DateAcademyJoinedTrust, previousRating.InspectionDate),
                    previousRating.InspectionDate?.ToString(StringFormatConstants.ViewDate) ?? string.Empty,
                    currentRating.OfstedRatingScore != OfstedRatingScore.None ? currentRating.OfstedRatingScore.ToDisplayString() : string.Empty,
                    IsOfstedRatingBeforeOrAfterJoining(currentRating.OfstedRatingScore, academy.DateAcademyJoinedTrust, currentRating.InspectionDate),
