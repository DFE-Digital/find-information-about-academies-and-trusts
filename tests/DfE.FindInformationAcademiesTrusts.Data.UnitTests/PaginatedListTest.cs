...
public class PaginatedListTest
{
    ...
    {
        _list.Pagination.PageIndex.Should().Be(0);
    }
    ...
    {
        SetupList(1);
        _list.Pagination.PageIndex.Should().Be(1);
    }
    ...
    {
        SetupList(3);
        _list.Pagination.PageIndex.Should().Be(3);
    }

    [Fact]
    public void TotalPages_property_is_0_by_default()
    {
        _list.Pagination.TotalPages.Should().Be(0);
    }
    ...
    {
        SetupList(1);
        _list.Pagination.TotalPages.Should().Be(4);
    }

    [Fact]
    public void TotalResults_property_is_0_by_default()
    {
        _list.Pagination.TotalResults.Should().Be(0);
    }
    ...
    {
        SetupList(1);
        _list.Pagination.TotalResults.Should().Be(20);
    }

    [Fact]
    public void HasPreviousPage_property_is_false_by_default()
    {
        _list.Pagination.HasPreviousPage.Should().Be(false);
    }
    ...
    {
        SetupList(4);
        _list.Pagination.HasPreviousPage.Should().Be(true);
    }

    [Fact]
    public void HasNextPage_property_is_false_by_default()
    {
        _list.Pagination.HasNextPage.Should().Be(false);
    }
    ...
    {
        SetupList(1);
        _list.Pagination.HasNextPage.Should().Be(true);
    }
