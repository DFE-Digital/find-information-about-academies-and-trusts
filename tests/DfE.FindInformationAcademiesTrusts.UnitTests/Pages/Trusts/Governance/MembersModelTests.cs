...
public class MembersModelTests
{
    private readonly MembersModel _sut;
    ...
    public MembersModelTests()
    {
        ...
        _sut = new MembersModel(_mockDataSourceService.Object,
                new MockLogger<MembersModel>().Object, _mockTrustRepository.Object)
            { Uid = TestUid };
    }
    ...
    public async Task OnGetAsync_sets_correct_SubNavigationLinks()
    {
        ...
        _sut.SubNavigationLinks.Should().BeEquivalentTo([
            ...
            new TrustSubNavigationLinkModel("Members (1)", "./Members", "1234", "Governance"){LinkIsActive = true},
