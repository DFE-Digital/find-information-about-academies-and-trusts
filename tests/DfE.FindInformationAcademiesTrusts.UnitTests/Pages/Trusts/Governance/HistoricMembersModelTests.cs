...
public class HistoricMembersModelTests
{
    private readonly HistoricMembersModel _sut;
    ...
    public HistoricMembersModelTests()
    {
        ...
        _sut = new HistoricMembersModel(_mockDataSourceService.Object,
                new MockLogger<HistoricMembersModel>().Object, _mockTrustRepository.Object)
            { Uid = TestUid };
    }
    ...
    public async Task OnGetAsync_sets_correct_SubNavigationLinks()
    {
        ...
        _sut.SubNavigationLinks.Should().BeEquivalentTo([
            ...
            new TrustSubNavigationLinkModel("Historic Members (1)", "./HistoricMembers", "1234",  "Governance"){LinkIsActive = true}
        ]);
    }
}
