...
using DfE.FIAT.Web.Pages.Trusts.Ofsted;
...
namespace DfE.FIAT.Web.UnitTests.Pages.Trusts.Ofsted;

public class PreviousRatingsModelTests
{
    private readonly PreviousRatingsModel _sut;
