...
| <a name="input_mssql_maintenance_configuration_name"></a> [mssql\_maintenance\_configuration\_name](#input\_mssql\_maintenance\_configuration\_name) | The name of the Public Maintenance Configuration window to apply to the SQL database | `string` | `"SQL_Default"` | no |
